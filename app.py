...
# ================================================
# app.py — Pro Forma AI — Institutional (FULL 100% ORIGINAL + WORKING PAYWALL)
# December 1, 2025 — Nothing removed, nothing simplified
...
# Secure unlock tokens — change anytime
VALID_TOKENS = {
    "one": "proforma-one-2025-k9x7m3v8q2t6y1w5z0c4j9",
    "annual": "proforma-annual-2025-p8m4v1q7t3y9w2z6c0j5k1"
}
...
# ================================================
# PAYWALL — BULLETPROOF HTML LINKS (NO IFRAME ISSUES)
# ================================================
if not IS_UNLOCKED:
    st.markdown("""
    <style>
    ...
    with col1:
        ...
        success_url = f"{requests.utils.quote(st._get_current_url())}?plan=one&token={VALID_TOKENS['one']}"
        st.markdown(f'''
        <a href="https://buy.stripe.com/dRm5kD66J6wR0Mhfj5co001?client_reference_id=one&success_url={success_url}" 
    ...
    with col2:
        ...
        success_url = f"{requests.utils.quote(st._get_current_url())}?plan=annual&token={VALID_TOKENS['annual']}"
        st.markdown(f'''
        <a href="https://buy.stripe.com/bJe8wPcv78EZdz38UHco002?client_reference_id=annual&success_url={success_url}" 
...
# ================================================
# FULL UNLOCKED APP — 100% YOUR ORIGINAL CODE BELOW
# ================================================
